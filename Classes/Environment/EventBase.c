...
class NamEventBase
{
	...
	protected float m_windMinTarget;
	protected float m_windMaxTarget;
	...
	{
		switch (m_EventState) {
			case NamEventPhase.INIT:	return m_InitPhaseLength;
			case NamEventPhase.MID: return m_MidPhaseLength;			
			case NamEventPhase.END: return m_EndPhaseLength;			
		}
		
		return 0;
	}
	
	NamEventPhase GetActivePhaseID()
	{
		return m_EventState;
	}
		
	void SwitchPhase(NamEventPhase phase, float time_remaining = 0)
	{
