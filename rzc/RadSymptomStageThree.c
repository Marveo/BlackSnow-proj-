class RadSymptomStageThree extends SymptomBase
{
	Material m_MatGauss;
	...
	const int BLUR_DURATION_TIME_MAX = 10.5;
	
	const int MIN_TIME_BETWEEN_EFFECTS = 10.0;
	const int MAX_TIME_BETWEEN_EFFECTS = 25.0;

	override void OnInit()
	{
		m_SymptomType = SymptomTypes.SECONDARY;
		m_Priority = 0;
		m_ID = RadDebuffSymptomIDs.SYMPTOM_RAD3;
