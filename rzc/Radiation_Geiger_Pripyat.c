class Radiation_Geiger_Pripyat extends ItemBase
{
    ...
    void ChangeDigit(int digitIndex, string number)
    {
        ...
        SetObjectTexture(hiddenSelectionIndex, "RadZoneSystemClient\\Geiger\\data\\digits\\" + number + ".paa");
    }
    ...
    override void OnWorkStop()
    {
        ...
        SetObjectTexture(GetHiddenSelectionIndex("num0"), "RadZoneSystemClient\\Geiger\\data\\digits\\nothing.paa");
        SetObjectTexture(GetHiddenSelectionIndex("num1"), "RadZoneSystemClient\\Geiger\\data\\digits\\nothing.paa");
        SetObjectTexture(GetHiddenSelectionIndex("num2"), "RadZoneSystemClient\\Geiger\\data\\digits\\nothing.paa");
        SetObjectTexture(GetHiddenSelectionIndex("num3"), "RadZoneSystemClient\\Geiger\\data\\digits\\nothing.paa");
